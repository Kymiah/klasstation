<script type="text/javascript" src="jquery/bootstrap/bootstrap.js"></script>
...
<div class="centro_perfil_turma">
			...
			<table border="0" align="left">
	       	<tr>
	       		<td rowspan="3"><img style="image-rendering: pixelated;" width="100" src="/klasstation/<?php echo $avatar_user; ?>" /></td>
	       		<td height="10px" width="60%"><?php echo $nome_user; ?></td>
	       	</tr>
	       	<tr>
	       		<td height="10px" style="font-size: 12px;">Contato: <?php echo $whatsapp_user; ?></td>	       		

	       	</tr>
	       	<td>
	       		<div class="trophy">
		       		<div class="trophy_img">
		       			<img width="30" src="<?php echo $icon_trophy[1];?>" />                    
		       		</div>
	       		...
	       		<div class="trophy">
		       		<div class="trophy_img">
		       			<img width="30" src="<?php echo $icon_trophy[2];?>" />                                       
		       		</div>
		       		<div class="info_trophy">
	       		...
	       		<div class="trophy">
		       		<div class="trophy_img">
		       			<img width="30" src="<?php echo $icon_trophy[3];?>" />                                       
		       		</div>
		       		<div class="info_trophy">
	       		...
	       		<div class="trophy">
		       		<div class="trophy_img">
		       			<img width="30" src="<?php echo $icon_trophy[4];?>" />                                       
		       		</div>
		       		<div class="info_trophy">
	...
	<div class="painel_alunos_turma"> 
		...
		<div class="painel_img_alunos">
			<?php  $sql_alunos_turma = mysqli_query($conectar, "Select * from ks_rel_disciplinas
				...
				WHERE id_disciplina = '$id_disciplina_sel' AND ks_rel_disciplinas.rel_disc_nivel = '0'");
			...
			{	
				...
				<a href="perfil_disciplina.php?url=<?php // echo $url_cript;?>" class="tooltip_aluno">
					<?php if(@$id_aluno == @$aluno_selected)
					{ ?>
						<div class="img_aluno_turma_s" ><img style="image-rendering: pixelated; margin-left: -1px; margin-top: -1px;" src="<?php echo $img_user; ?>" width="40"/>  </div>
						<?php 
					}
					else{ ?>
					<div class="img_aluno_turma" ><img style="image-rendering: pixelated; margin-left: -1px; margin-top: -1px;" src="<?php echo $img_user; ?>" width="40"/>   </div>
					<?php } ?>
